...
prizes[0] = {"name" : "50% OFF YOUR RIDE",			"startAngle" : 0,    "endAngle" : 29};  
prizes[1] = {"name" : "FIFA VIDEO GAME 2018",		"startAngle" : 35,   "endAngle" : 89};
prizes[2] = {"name" : "FREE RIDE",					"startAngle" : 95,   "endAngle" : 148};
prizes[3] = {"name" : "70% OFF YOUR RIDE",			"startAngle" : 153,  "endAngle" : 209};
prizes[4] = {"name" : "FOOTBALL JERSEY",			"startAngle" : 215,  "endAngle" : 270};
prizes[5] = {"name" : "BLUETOOTH SPEAKER",			"startAngle" : 275,  "endAngle" : 330};
prizes[6] = {"name" : "50% OFF YOUR RIDE",			"startAngle" : 336,  "endAngle" : 360}; 
prizes[7] = {"name" : "SORRY :(",					"startAngle" : 32,   "endAngle" : 34};

// 50% OFF YOUR RIDE -> 0 to 29 & 336 to 360
// FIFA VIDEO GAME 2018 -> 35 to 89
// FREE RIDE -> 95 to 148
// 70% OFF YOUR RIDE-> 153 to 209
// FOOTBALL JERSEY -> 215 to 270
// BLUETOOTH SPEAKER -> 275 to 330
// SORRY :( -> 32 to 34
...
{		
	...
	{	
		...
		if(prize == "50% OFF YOUR RIDE") {
			var stopAngles = [Math.floor(Math.random() * (29 - 0 + 1)) + 0, Math.floor(Math.random() * (360 - 336 + 1)) + 336];
			stopAngle = stopAngles[Math.floor(Math.random() * stopAngles.length)];
		} else if(prize == "FIFA VIDEO GAME 2018") {
			stopAngle = Math.floor(Math.random() * (89 - 35 + 1)) + 35;
		} else if(prize == "FREE RIDE") {
			stopAngle = Math.floor(Math.random() * (148 - 95 + 1)) + 95;
		} else if(prize == "70% OFF YOUR RIDE") {
			stopAngle = Math.floor(Math.random() * (209 - 153 + 1)) + 153;
		} else if(prize == "FOOTBALL JERSEY") {
			stopAngle = Math.floor(Math.random() * (270 - 215 + 1)) + 215;
		} else if(prize == "BLUETOOTH SPEAKER") {
			stopAngle = Math.floor(Math.random() * (330 - 275 + 1)) + 275;
		} else if(prize == "SORRY :(") {
			stopAngle = 33;
		} else {
			stopAngle = 33;
